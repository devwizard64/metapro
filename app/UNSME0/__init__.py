...
a00_ins = {
    ...
    0x802CD19C:
        ...
        "    at = *cpu_s32(sp+0x7C);\n"
        "    *cpu_u32(sp+0x7C) = at+0x28;\n"
        "    *cpu_u32(at+0x00) = 0xBA001402;\n"
        "    *cpu_u32(at+0x04) = 0x00300000;\n"
        "    *cpu_u32(at+0x08) = 0xF7000000;\n"
        "    *cpu_u32(at+0x0C) = 0x00010001;\n"
        "    *cpu_u32(at+0x10) = 0xF60003BC | ((  x-1) & 0x3FF) << 14;\n"
        "    *cpu_u32(at+0x14) = 0x00000000;\n"
        "    *cpu_u32(at+0x18) = 0xF64FC3BC;\n"
        "    *cpu_u32(at+0x1C) = 0x00000000 | ((320-x) & 0x3FF) << 14;\n"
        "    *cpu_u32(at+0x20) = 0xBA001402;\n"
        "    *cpu_u32(at+0x24) = 0x00000000;\n"
        "}\n",
    # pause
